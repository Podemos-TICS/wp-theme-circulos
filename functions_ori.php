...
function starkers_comment($comment, $args, $depth) {
    ...
    function customtypes_meta_box_callback1($post) {
        ...
        /*
         * Para crear un nuevo atributo solo hay que copiar el siguiente código y cambiar -> customtypes_nombredelatributo todas las veces que aparezca
         */
        ...
        echo '</label> ';
        echo '<input class="required" type="text" id="customtypes_telefono" name="customtypes_telefono" value="' . esc_attr($value) . '"  />';
        echo '<br>';
        $value = get_post_meta($post->ID, 'ffinal', true);
        echo '<label for="customtypes_fechafinal">';
        _e('Fecha del Final del Evento:  ', 'customtypes_textdomain1');
